...
class WorkoutChartRendererTest {
	...
	fun `renderWeightProgress returns valid png`() {
		val points =
			listOf(
				WorkoutChartRenderer.Point(LocalDate.of(2026, 6, 1), 70, 10),
				WorkoutChartRenderer.Point(LocalDate.of(2026, 6, 8), 72, 11),
				WorkoutChartRenderer.Point(LocalDate.of(2026, 6, 15), 75, 9),
			)
