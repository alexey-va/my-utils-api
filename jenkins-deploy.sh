...
export OPENROUTER_PROXY_ENABLED="${OPENROUTER_PROXY_ENABLED:-false}"
export OPENROUTER_PROXY_HOST="${OPENROUTER_PROXY_HOST:-}"
export OPENROUTER_PROXY_PORT="${OPENROUTER_PROXY_PORT:-8888}"
